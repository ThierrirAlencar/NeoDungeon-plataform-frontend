...
export function buildDummySheetAtLocalStorage(dummy_sent:Partial<Character>): optmizedDNDTokenFormat {
        ...
        const dummy_sheet: optmizedDNDTokenFormat = {
            ...
            character: {
                ...
                character_skills: {
                    accrobatics: { value: 0, trained: false },
                    arcanism: { value:0, trained: false },
                    acting: { value: 0, trained: false },
                    stealth: { value: 0, trained: false },
                    intimidation: { value: 0, trained: false },
                    investigation: { value: 0, trained: false },
                    nature: { value: 0, trained: false },
                    persuasion: { value: 0, trained: false },
                    religion: { value: 0, trained: false },
                    care_animals: { value: 0, trained: false },
                    atletism: { value: 0, trained: false },
                    deception: { value: 0, trained: false },
                    history: { value: 0, trained: false },
                    intuition: { value: 0, trained: false },
                    medicine: { value: 0, trained: false },
                    perception: { value: 0, trained: false },
                    Sleight_of_hand: { value: 0, trained: false },
